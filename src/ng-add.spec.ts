...
describe('ng-add', () => {
  ...
  beforeEach(() => {
    ...
    expectedWorkspaceDefinition = JSON.parse(JSON.stringify(originalWorkspaceDefinition));
  ...
  describe('generating files', () => {
    ...
    it('should set the deployer only on publishable libraries using workspace.json', () => {
      tree.create('workspace.json', JSON.stringify(originalWorkspaceDefinition));
  ...
  describe('error handling', () => {
    ...
    it('Should throw if workspace definition can not be parsed', () => {
      ...
      expect(() => ngAdd()(tree)).toThrowError('Could not parse workspace definition');
    });
    ...
    it('should throw if there is no library to add the deployer', () => {
      ...
      Object.keys(originalWorkspaceDefinition.projects)
        .filter(
          projectKey =>
            originalWorkspaceDefinition.projects[projectKey].projectType === 'library'
        )
        .forEach(libraryKey => {
